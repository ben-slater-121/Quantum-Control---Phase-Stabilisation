...
def _save_fringes(heater_name, voltages, powers_mW):
    ...
    #np.savetxt(f'C:/Users/bs15598/University of Bristol/grp-Multi 3 Chip Project - Documents/Multi_3_Chips/pycode_molly/Experimental code/Experimental data/Calibration/Fringes/{heater_name}_{int(time.time())}.csv', saving_array,delimiter=',', header='#voltages,powers_mW')
    np.savetxt(f'Experimental data/Calibration/Fringes/{heater_name}_{int(time.time())}.csv', saving_array,delimiter=',', header='#voltages,powers_mW')
